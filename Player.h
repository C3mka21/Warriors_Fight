...
private:
    ...
    const double oldxsp = xspeed;         /// <-  Хранит изначальную скорость игрока по x
    ...
    const int ohp = hp;                   /// <-  Хранит изначальное количество ХП(жизни) персонажа
...
public:
    ...
    inline double get_height(){ return h;}
